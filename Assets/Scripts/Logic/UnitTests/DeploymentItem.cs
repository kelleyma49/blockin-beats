...
namespace Logic.Tests
{
	...
	public class DeploymentItemAttribute : Attribute
	{
		...
		public DeploymentItemAttribute(string path, string outputDirectory = null)
		{
			...
			string filePath = path.Replace("/", "" + Path.DirectorySeparatorChar).Replace("\\", ""+ Path.DirectorySeparatorChar);
			...
			{
                throw new FileNotFoundException("Warning: Deployment item does not exist - \"" + itemPath + "\"");
			}
		}
	}
}
